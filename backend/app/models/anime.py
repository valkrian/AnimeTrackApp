...
class AnimeItem(BaseModel):
    ...
    score: Optional[float] = Field(
        None, ge=0, le=10, description="Average score (0-10)"
    )
    scored_by: Optional[int] = Field(
        None, ge=0, description="Number of users who scored"
    )
    ...
    broadcast: Optional[AnimeBroadcast] = Field(
        None, description="Broadcast information"
    )
